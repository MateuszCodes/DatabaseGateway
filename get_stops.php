<?php
	...
	$result = mysqli_query($con, "SELECT busstop.stopID, busstop.stopName FROM busstops, has WHERE has.routeID = '$routeID' and busstop.stopID = has.stopID ORDER BY has.sequence ASC");
